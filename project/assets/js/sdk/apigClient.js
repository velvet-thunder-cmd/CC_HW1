...
apigClientFactory.newClient = function (config) {
    ...
    if(config === undefined) {
        config = {
            accessKey: "AKIATIKE3SY6ZENULU5R",
            secretKey: '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',
            sessionToken: '',
            region: 'us-west-2',
            apiKey: undefined,
    ...
    var invokeUrl = 'https://yoplcjwy42.execute-api.us-west-2.amazonaws.com/test';
